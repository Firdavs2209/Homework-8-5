...
SECRET_KEY = 'django-insecure-a#03!#0s9hw&by@)+k48tfztcl342*m(9)%ax&i7q)us_3es1p'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = getenv('jcjdjd713@gmail.com')
...
EMAIL_HOST_PASSWORD = getenv('qtup wzgk fpgm btml')
# EMAIL_USE_SSL = True
